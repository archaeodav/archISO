...
class ArchISO:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ArchISO', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/arch_iso/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
